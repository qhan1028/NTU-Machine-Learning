...
ETA = 1e-8
LAMBDA = 0.01
VALIDATION = 576 # validation size
DATA_SIZE = 1
...
def print_message():
	print("\nLinear Regression: SGD and REG" if SGD else "\nLinear Regression and REG")
...
def train_LR():
	...
	for i in range(ITERATION):
		...
		# update parameters
		w = w - ETA * (sum_gradient_X + 2. * LAMBDA * w)
